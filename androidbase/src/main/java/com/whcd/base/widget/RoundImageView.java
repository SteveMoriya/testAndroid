 ...
 * </p>
 * 
 * @author 刘树宝 2016年4月6日 下午5:29:41
 * @version V1.0
 * 
...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		TypedArray types = this.context.obtainStyledAttributes(attrs, R.styleable.roundedimageview);

		borderThickness = types.getDimensionPixelSize(R.styleable.roundedimageview_border_thickness,
				DEFAUTL_BORDER_THICKNESS);
		borderInsideThickness = types.getDimensionPixelSize(R.styleable.roundedimageview_border_inside_thickness,
				DEFAUTL_BORDER_THICKNESS);
		borderOutsideThickness = types.getDimensionPixelSize(R.styleable.roundedimageview_border_outside_thickness,
				DEFAUTL_BORDER_THICKNESS);
		...
		borderColor = types.getColor(R.styleable.roundedimageview_border_color, DEFAULT_COLOR);
		borderInsideColor = types.getColor(R.styleable.roundedimageview_border_inside_color, DEFAULT_COLOR);
		borderOutsideColor = types.getColor(R.styleable.roundedimageview_border_outside_color, DEFAULT_COLOR);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (b == null) {
			b = drawableToBitmap(getDrawable());
		}
		...
		int radius = minSize / 2 - borderInsideThickness - borderOutsideThickness;
		...
		// drawOutSideBorder
		drawCircleBorder(canvas, cx, cy, radius + borderInsideThickness + borderOutsideThickness / 2,
				borderOutsideColor, borderOutsideThickness);
