 ...
 * 
 */
public class SearchBar extends EditText implements OnFocusChangeListener, TextWatcher {
	// 删除按钮的引用
	...
	private void init() {
		...
		if (clearDrawable == null) {
			clearDrawable = getResources().getDrawable(R.drawable.ic_clear_search_bar);
		}
