...
public class EaseChatRowVoice extends EaseChatRowFile {
	...
	protected void onSetUpView() {
		...
		if (EaseChatRowVoicePlayClickListener.playMsgId != null && EaseChatRowVoicePlayClickListener.playMsgId.equals(message.getMsgId())
			...
			bubbleLayout.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (itemClickListener != null) {
						itemClickListener.onBubbleClick(message, bubbleLayout, voiceImageView, readStutausView, adapter);
					}
				}
			});
