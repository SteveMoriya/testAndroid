package com.whcd.base.component.easeui.widget.emojicon;
...
import com.whcd.base.component.easeui.adapter.EmojiconGridAdapter;
import com.whcd.base.component.easeui.adapter.EmojiconPagerAdapter;
...
public class EaseEmojiconPagerView extends ViewPager {
	...
	public interface EaseEmojiconPagerViewListener {
		 ...
		 * pagerview初始化完毕
		 * 
		 * @param groupMaxPageSize
		 *            最大表情组的page大小
		 * @param firstGroupPageSize
		 *            第一组的page大小
		 */
