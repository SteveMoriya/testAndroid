...
import com.whcd.base.component.easeui.widget.emojicon.EaseEmojiconPagerView.EaseEmojiconPagerViewListener;
...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase {
	...
	public void init(List<EaseEmojiconGroupEntity> groupEntities) {
		...
		// tabBar.setTabBarItemClickListener(new
		// EaseScrollTabBarItemClickListener() {
		// @Override
