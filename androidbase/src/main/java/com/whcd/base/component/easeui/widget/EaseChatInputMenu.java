...
import com.whcd.base.component.easeui.domain.EaseEmojicon;
import com.whcd.base.component.easeui.domain.EaseEmojiconGroupEntity;
import com.whcd.base.component.easeui.model.EaseDefaultEmojiconDatas;
import com.whcd.base.component.easeui.utils.EaseCommonUtils;
import com.whcd.base.component.easeui.utils.EaseSmileUtils;
import com.whcd.base.component.easeui.utils.SharedPreferencesUtils;
import com.whcd.base.component.easeui.widget.EaseChatExtendMenu.EaseChatExtendMenuItemClickListener;
import com.whcd.base.component.easeui.widget.EaseChatPrimaryMenuBase.EaseChatPrimaryMenuListener;
import com.whcd.base.component.easeui.widget.emojicon.EaseEmojiconMenu;
import com.whcd.base.component.easeui.widget.emojicon.EaseEmojiconMenuBase;
import com.whcd.base.component.easeui.widget.emojicon.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
import com.whcd.base.component.easeui.widget.gift.EaseGIftMenu;
import com.whcd.base.component.easeui.widget.gift.EaseGIftMenu.EaseGiftMenuListener;
import com.whcd.base.component.easeui.widget.gift.EaseGIftMenu.RefreshLeftDiamoundListener;
import com.whcd.base.component.easeui.widget.gift.EaseGiftEntity;
...
public class EaseChatInputMenu extends LinearLayout {
	...
	protected FrameLayout giftMenuContainer;
	protected LayoutInflater layoutInflater;
	private EaseGIftMenu gIftMenu;
	 ...
	 */
	public void init(List<EaseEmojiconGroupEntity> emojiconGroupList, List<EaseGiftEntity> giftEntities) {
		if (inited) {
			return;
		}
		...
		gIftMenu = (EaseGIftMenu) layoutInflater.inflate(R.layout.ease_layout_gift_menu, null);
		gIftMenu.setEaseGiftMenuListener(new EaseGiftMenuListener() {
			@Override
			public void onGiftSendClicked(EaseGiftEntity giftEntity, RefreshLeftDiamoundListener callback) {
				if (listener != null) {
					listener.sendGift(giftEntity, callback);
				}
			}
			...
			@Override
			public int getLeftDiamound() {
				if (listener != null) {
					return listener.getLeftDiamound();
				}
				return 0;
			}
		});

		gIftMenu.init(giftEntities);
		giftMenuContainer.addView(gIftMenu);
	...
	public void showGiftMenu() {
		...
		gIftMenu.setVisibility(View.VISIBLE);
	}
	...
	protected void toggleMore() {
		if (chatExtendMenuContainer.getVisibility() == View.GONE) {
			...
			handler.postDelayed(new Runnable() {
				public void run() {
					LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) chatExtendMenuContainer.getLayoutParams();
					params.height = EaseCommonUtils.getKeyboardHeight((Activity) context);
					chatExtendMenuContainer.setVisibility(View.VISIBLE);
					chatExtendMenuContainer.setLayoutParams(params);
					chatExtendMenu.setVisibility(View.VISIBLE);
					emojiconMenu.setVisibility(View.GONE);
					gIftMenu.setVisibility(View.GONE);
				}
			}, 50);
		} else {
	...
	public interface ChatInputMenuListener {
		...
		void sendGift(EaseGiftEntity easeGiftEntity, RefreshLeftDiamoundListener callback);
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (b != height) {
			EaseCommonUtils.getKeyboardHeight((Activity) context);
		}
	}
}
