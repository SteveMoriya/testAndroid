 ...
 *******************************************************************************/
package com.whcd.base.component.photoview;
...
public interface IPhotoView {
	...
	/**
	 * Sets the Display Matrix of the currently displayed Drawable. The Rectangle is considered relative to this View and includes all scaling and translations.
	 *
	 * @param finalMatrix
	...
	/**
	 * Gets the Display Matrix of the currently displayed Drawable. The Rectangle is considered relative to this View and includes all scaling and translations.
	 *
	 * @return - true if rectangle was applied successfully
	 */
	...
	/**
	 * Enables rotation via PhotoView internal functions. Name is chosen so it won't collide with View.setRotation(float) in API since 11
	 *
	 * @param rotationDegree
	 *            - Degree to rotate PhotoView to, should be in range 0 to 360
	...
	/**
	 * Extracts currently visible area to Bitmap object, if there is no image loaded yet or the ImageView is already destroyed, returns {@code null}
	 *
	...
	/**
	 * Allows to change zoom transition speed, default value is 200 (PhotoViewAttacher.DEFAULT_ZOOM_DURATION). Will default to 200 if provided negative value
	 *
	 * @param milliseconds
	...
	/**
	 * Sets custom double tap listener, to intercept default given functions. To reset behavior to default, you can just pass in "null" or public field of
