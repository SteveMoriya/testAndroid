...
public class ScreenSwitchUtils {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
              ...
              /*      if (orientation > 45 && orientation < 135) {
                    ...
                    if (((orientation >= 0) && (orientation <= 45)) || (orientation >= 315)||((orientation>=135)&&(orientation<=225))) {//portrait
                        if (!isPortrait) {
                            Log.e(test,"切换成竖屏");
    ...
    public void start(Activity activity) {
        ...
        mActivity = activity;
        sm.registerListener((SensorEventListener) listener, sensor, SensorManager.SENSOR_DELAY_UI);
    }
    ...
    private boolean isafterShowBig=false;
