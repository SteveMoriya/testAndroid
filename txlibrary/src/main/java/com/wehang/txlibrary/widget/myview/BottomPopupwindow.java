...
public class BottomPopupwindow extends PopupWindow implements OnClickListener {
	...
	public BottomPopupwindow(final View v, Context context, shareBean shareBean) {
		this.v = v;
		this.context=context;
		this.shareBean=shareBean;
		mInflater = LayoutInflater.from(context);
		liveToolsPopupwindow = mInflater.inflate(R.layout.fxpopwindows, null);
		popupWindow = new PopupWindow(liveToolsPopupwindow, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
		...
		liveToolsPopupwindow.findViewById(R.id.fx_qx).setOnClickListener(this);
