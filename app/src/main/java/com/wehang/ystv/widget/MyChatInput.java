...
import com.wehang.ystv.component.imui.VideoInputDialog;
 ...
 * 聊天界面输入控件
 */
public class MyChatInput extends RelativeLayout implements TextWatcher, View.OnClickListener {
    ...
    public MyChatInput(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.mychat_input, this);
        initView();
    }
...
//
    ...
    public void onClick(View v) {
        ...
        LiveWatchNewActivity activity1= (LiveWatchNewActivity) activity;
        int id = v.getId();
        if (id == R.id.btn_send) {
            chatView.sendText();
        }
        ...
        if (id == R.id.btnEmoticon) {
            ...
            if (inputMode == MyChatInput.InputMode.EMOTICON){
