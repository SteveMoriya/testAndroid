...
import com.wehang.ystv.adapter.SysTemMessageAdapter;
...
public class SysTemMessageActivty extends BaseActivity implements PageListView.PageListViewListener{
    ...
    protected int getLayoutResId() {
        return R.layout.activity_sys_tem_message_activty;
    }

    @Override
    protected void initTitleBar() {
        TopMenuBar topMenuBar = (TopMenuBar) findViewById(R.id.topMenuBar);
        topMenuBar.setTitle("系统消息");
    ...
    private void initData() {
        ...
        params.put("type","1");
        HttpTool.doPost(this, UrlConstant.SYSMESSAGE, params, false, new TypeToken<BaseResult<GetSysMResult>>() {
            ...
            public void onSuccess(BaseData data) {
                ...
                if (result.sysMessages.size() < pageSize) {
                    listView.setPullLoadEnable(false);
                } else {
                ...
                if (result.sysMessages != null && result.sysMessages.size() != 0) {
                    list.addAll(result.sysMessages);
                }
            ...
            public void onError(int errorCode) {
                UserLoginInfo.loginOverdue(SysTemMessageActivty.this, errorCode);
                listView.stopRefresh();
                listView.stopLoadMore();
            }
        });
