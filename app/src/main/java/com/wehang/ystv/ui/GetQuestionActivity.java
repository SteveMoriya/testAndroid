...
public class GetQuestionActivity extends BaseActivity implements PageListView.PageListViewListener{
    ...
    protected void initView() {
        ...
        adapter = new QuestionAdapter(context, list,2);
    ...
    private void initData() {
        ...
        HttpTool.doPost(this, UrlConstant.SYSMESSAGE, params, false, new TypeToken<BaseResult<GetSysMResult>>() {
            ...
            public void onSuccess(BaseData data) {
                ...
                if (result.questionMessages.size() < pageSize) {
                    listView.setPullLoadEnable(false);
                } else {
                ...
                if (result.questionMessages != null && result.questionMessages.size() != 0) {
                    list.addAll(result.questionMessages);
                }
            ...
            public void onError(int errorCode) {
                UserLoginInfo.loginOverdue(GetQuestionActivity.this, errorCode);
                listView.stopRefresh();
                listView.stopLoadMore();
            }
        });
