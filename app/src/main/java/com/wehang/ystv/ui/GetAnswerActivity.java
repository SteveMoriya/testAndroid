...
import com.wehang.ystv.adapter.AnswerAdapter;
...
public class GetAnswerActivity extends BaseActivity implements PageListView.PageListViewListener {
    ...
    private void initData() {
        ...
        HttpTool.doPost(this, UrlConstant.SYSMESSAGE, params, false, new TypeToken<BaseResult<GetSysMResult>>() {
            ...
            public void onSuccess(BaseData data) {
                ...
                if (result.answerMessages.size() < pageSize) {
                    listView.setPullLoadEnable(false);
                } else {
                ...
                if (result.answerMessages != null && result.answerMessages.size() != 0) {
                    list.addAll(result.answerMessages);
                }
