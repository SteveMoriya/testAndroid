...
import com.wehang.ystv.component.clearscreen.view.ScreenSideView;
...
public class ClearScreenHelper {
    ...
    private void initView(Context context, IClearRootView root) {
        if (root == null) {
            ...
            mScreenSideView = (IClearRootView) new ScreenSideView(context);
    ...
    private void initPara() {
        ...
        setOrientation(ClearScreenConstants.Orientation.RIGHT);
    }
    ...
    public void setOrientation(ClearScreenConstants.Orientation orientation) {
