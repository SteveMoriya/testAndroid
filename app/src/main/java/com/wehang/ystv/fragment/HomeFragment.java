 ...
 */
public class HomeFragment extends Fragment implements HomeViewPager.OnScrollChanged ,View.OnClickListener{
    ...
    private void initFragment() {
        ...
        homeFragmentList.add(new LiveFragment());
        homeFragmentList.add(new VideoFragment());
        homeFragmentList.add(new PreFragment());
    }
    @Override
