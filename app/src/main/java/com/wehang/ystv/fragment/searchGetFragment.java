...
public class searchGetFragment extends BaseFragment implements PageListView.PageListViewListener{
    ...
    private int type;
    @SuppressLint("ValidFragment")
    public searchGetFragment(int type ) {
    ...
    public void initData() {
        ...
        params.put("keyword",activity.keyword);
        params.put("type",type+"");
        HttpTool.doPost(getActivity(), UrlConstant.SEARCH, params, false, new TypeToken<BaseResult<GetLvesResult>>() {
            ...
            public void onSuccess(BaseData data) {
                ...
                if (result.sources.size() < pageSize) {
                    listView.setPullLoadEnable(false);
                } else {
                ...
                if (result.sources != null && result.sources.size() != 0) {
                    nearLives.addAll(result.sources);
                }
