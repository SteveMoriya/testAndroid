...
public class TCLoginMgr {
    ...
    public void imLogin(@NonNull String identify, @NonNull String userSig) {
        ...
        user.setAccountType(String.valueOf(Constant.IMSDK_ACCOUNT_TYPE));
        user.setAppIdAt3rd(String.valueOf(Constant.IMSDK_APPID));
        user.setIdentifier(identify);
        //发起登录请求
        TIMManager.getInstance().login(Constant.IMSDK_APPID, user, userSig, new TIMCallBack() {
            @Override
     ...
     *
     */
    public void loginIm(String identify, String userSig){
    ...
    public void init(Context context) {
        ...
        mTLSLoginHelper = TLSLoginHelper.getInstance().init(context,
                Constant.IMSDK_APPID, Constant.IMSDK_ACCOUNT_TYPE, "1.0");
