...
import com.wehang.ystv.interfaces.FriendshipManageView;
import com.wehang.ystv.interfaces.FriendshipMessageView;
...
public class FriendshipManagerPresenter {
     ...
     * 获取自己的资料
     */
    private String tag="qiutest";
    public void getMyProfile() {
        if (friendInfoView == null) return;
        TIMFriendshipManager.getInstance().getSelfProfile(new TIMValueCallBack<TIMUserProfile>() {
            @Override
            public void onError(int code, String s) {
                LogUtils.i(tag, "getSelfProfile failed: " + code + " "+s);
            ...
            public void onSuccess(TIMUserProfile profile) {
                ...
                Log.e(tag, "identifier: " + profile.getIdentifier() + " nickName: " + profile.getNickName()
                        + " remark: " + profile.getRemark() + " allow: " +profile.getAllowType());
    ...
    public void addFriend(final String id, String remark, String group, String message) {
        ...
        conversation.sendMessage(msg, new TIMValueCallBack<TIMMessage>() {
            @Override
            public void onError(int i, String s) {
                LogUtils.v(TAG, "conversation.sendMessage error result: " + s);
            }

            @Override
            public void onSuccess(TIMMessage timMessage) {
                LogUtils.v(TAG, "conversation.sendMessage success");
            }
        });
