                ...
                try {
                    ...
                    if (Constant.LINKMIC_CMD_REQUEST == action) {
                        if (supportLinkMic()) {
                            ...
                            sendLinkMicResponse(userId, Constant.LINKMIC_RESPONSE_TYPE_REJECT, "主播端不支持连麦");
                        }
                      ...
                      /*  String reason = "";
                        ...
                        mLinkMicListener.onReceiveLinkMicResponse(userId, Constant.LINKMIC_RESPONSE_TYPE_REJECT, "观众拒绝连麦");
